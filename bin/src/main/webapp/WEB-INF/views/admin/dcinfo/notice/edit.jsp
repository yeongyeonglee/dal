		...
		<fieldset class="reg-field">
			...
			<table class="table-garo2">
				<tbody>
					...
					<tr>
						<td style="width: 270px;">기간</td>
						<td colspan="3"><input style="margin-left: -200px;" type="text" name="dur" value="${n.dur}" /></td>
					</tr>
					<tr>
					...
					<tr>
						<td colspan="4"><textarea style="overflow: auto;" name="dcontent" rows="40" cols="100">${n.dcontent}</textarea>
