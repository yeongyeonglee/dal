...
<%-- <link type='text/javascript' href="${path}/resource/js/jquery.js">
<link type='text/javascript' href="${path}/resource/js/jquery-ui-custom.js">
<link type='text/javascript' href="${path}/resource/js/fullcalendar.min.js"> --%>
